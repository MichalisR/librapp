 ...
 * Description:Class that creates or updates user data stored
 * in the SQLite Database created inside the smart phone
 */
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "librappc_librapp";
